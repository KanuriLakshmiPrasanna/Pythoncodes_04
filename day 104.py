...
2: Chef is already at the same coordinate as Chefina. Thus, he needs 0 steps.

Test case 3: Chef can use 1 step to decrease his coordinate by 46 which is less than K=100 and reach Chefina.

Test case 4: Chef can use 13 steps to decrease his coordinate by K=2 and reach the coordinate 30−13⋅2=4.30−13⋅2=4.'''

import math
for _ in range(int(input())):
    A,B,K=map(int,input().split())
    steps_left_to_reach_Chefia=abs(A-B)
    print(math.ceil(steps_left_to_reach_Chefia/K))